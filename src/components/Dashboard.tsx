...
import { BarChart3, TrendingUp, Activity, Glasses, Database, Brain, Zap, Clock, CheckCircle, ArrowUp, Star, Cpu, HardDrive, Gauge } from 'lucide-react';
...
function Dashboard() {
  ...
  return (
    <section className="p-3 min-h-screen bg-gradient-to-b from-[#006889] to-black text-white">
      ...
      <div className="flex justify-center mb-8">
        <DeviceInterface
          ...
          onDeviceClick={() => handleDeviceClick(mostRecent)}
          details={
            <>
      ...
      {/* Key Metrics Grid */}
      <div className="flex justify-between items-center w-[100%] gap-1 p-8 bg-black/300">
        ...
        <div className="bg-gradient-to-b from-black to-[#005778] w-[60%] p-3 m-auto rounded-lg border border-[#00699a]/30 hover:border-[#00699a] transition-all duration-300">
...
<div className='flex flex-col justify-between items-center w-full h-full'>
        <div className="bg-gradient-to-b from-black to-[#005778] w-[60%] p-3 rounded-lg border border-[#00699a]/30 hover:border-[#00699a] transition-all duration-300">
          <div className="flex items-center justify-between mb-4">
            <div className="p-2 bg-[#00beef]/20 rounded-lg">
        ...
        <div className="bg-gradient-to-b from-black to-[#005778] w-[60%] p-3 rounded-lg border border-[#00699a]/30 hover:border-[#00699a] transition-all duration-300">
          <div className="flex items-center justify-between mb-4">
            <div className="p-2 bg-[#00beef]/20 rounded-lg">
              <Glasses className="w-6 h-6 text-[#00beef]" />
            </div>
            <div className="flex items-center text-green-400 text-sm">
              <ArrowUp size={16} />
              <span>+2%</span>
          ...
          <div className="text-gray-300 text-sm">Accuracy difference</div>
          <div className="mt-2 text-xs text-gray-400">This {timeRange}</div>
        </div>
        <div className="bg-gradient-to-b from-black to-[#005778] w-[60%] p-6 rounded-lg border border-[#00699a]/30 hover:border-[#00699a] transition-all duration-300">
          <div className="flex items-center justify-between mb-4">
            <div className="p-2 bg-[#00beef]/20 rounded-lg">
      ...
      {/* Other Devices */}
      {showMore && (
        <div className="flex flex-wrap gap-8 justify-center overflow-auto custom-scrollbar p-4 mb-8">
      ...
      {showDeviceDetails && selectedDevice && (
        <div className="fixed inset-0 bg-black/70 backdrop-blur-sm flex items-center justify-center z-50">
          <div className="bg-gradient-to-b from-black to-[#005778] p-6 rounded-lg border border-[#00699a] max-w-2xl w-full mx-4 max-h-[80vh] overflow-y-auto">
            <div className="flex justify-between items-center mb-6">
              <h3 className="text-2xl font-bold text-white">{selectedDevice.name} Details</h3>
              <button 
            ...
            <div className="space-y-6">
              <div className="grid grid-cols-2 gap-4">
                <div className="bg-black/40 p-4 rounded-lg">
                  ...
                  <div className="space-y-2 text-sm">
                    <div>Accuracy: <span className="text-green-400">{selectedDevice.accuracy}%</span></div>
                    <div>Uptime: <span className="text-blue-400">{selectedDevice.uptime}%</span></div>
                    <div>Status: <span className="text-yellow-400 capitalize">{selectedDevice.status}</span></div>
                  </div>
                </div>
                
                <div className="bg-black/40 p-4 rounded-lg">
                  <h4 className="text-cyan-300 font-semibold mb-2">Usage</h4>
                  <div className="space-y-2 text-sm">
                    <div>Requests: <span className="text-purple-400">{selectedDevice.requests.toLocaleString()}</span></div>
                    <div>Type: <span className="text-orange-400 capitalize">{selectedDevice.type}</span></div>
                    <div>Device ID: <span className="text-gray-400">{selectedDevice.id}</span></div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-black/40 p-4 rounded-lg">
                ...
                <p className="text-gray-300 text-sm leading-relaxed">{selectedDevice.detailedDescription}</p>
              </div>

              <div className="bg-black/40 p-4 rounded-lg">
                <h4 className="text-cyan-300 font-semibold mb-2">Recent Activity</h4>
                <div className="space-y-2 text-sm">
            ...
            <div className="flex gap-3 mt-6">
              <button className="flex-1 px-4 py-2 bg-[#00beef] hover:bg-[#00699a] text-black font-semibold rounded-lg transition-colors duration-300">
                Configure Device
              </button>
              <button 
                onClick={() => setShowDeviceDetails(false)}
