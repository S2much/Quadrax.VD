...
import { Upload, Download, Eye, BarChart3, Database, Search, Filter, RefreshCw, Trash2, Plus, FileSpreadsheet, Image, FileText, Zap, Wrench, Shield, Bolt } from 'lucide-react';
...
function Datakits() {
  ...
  const datasets = [
    ...
    {
      id: 2,
      name: 'Hand_Tools_Mechanical_Dataset',
      type: 'JSON',
      size: '3.8 MB',
      rows: '50+',
