...
import { Terminal as TerminalIcon, X, Copy, Download, Power, ChevronUp, ChevronDown } from 'lucide-react';
    ...
    >
      ...
      {!isMinimized && (
        <>
          ...
          {/* Terminal Footer */}
          <div className="px-4 py-1 bg-gradient-to-r from-[#005778] to-black border-t border-[#00699a] text-xs text-gray-400 flex justify-between items-center">
